...
[![shellcheck](https://github.com/Jhatchi/Linux-HIDS-Bash-BC-2026/actions/workflows/shellcheck.yml/badge.svg)](https://github.com/Jhatchi/Linux-HIDS-Bash-BC-2026/actions/workflows/shellcheck.yml)
...
```bash
git clone https://github.com/Jhatchi/Linux-HIDS-Bash-BC-2026.git && cd Linux-HIDS-Bash-BC-2026
...
sudo pkill -f "Linux-HIDS-Bash-BC-2026" 2>/dev/null
...
cd ~
sudo rm -rf Linux-HIDS-Bash-BC-2026
```
